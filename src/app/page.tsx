      ...
      <div className="text-black max-w-[1440px] mx-auto px-4 md:px-6 lg:px-10 xl:px-20">
        <div className="mt-6">
          ...
          <p className="text-base sm:text-[20px] font-normal leading-[30px]">
            ...
            clubs, with proceeds going to support children in disadvantaged
            areas. We aim to empower children through sustainable actions,
            ensuring they have the resources and opportunities they need to
            thrive.
          </p>
        </div>
        ...
        <div className="mt-12" id="Donate">
          ...
          <div className="flex max-lg:flex-col-reverse">
            <div className="relative lg:w-1/2 h-full aspect-[621/480] flex-shrink-0">
              <Image fill src={"/homepage-grid.png"} alt="" />
            </div>
