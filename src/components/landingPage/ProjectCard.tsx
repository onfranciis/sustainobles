...
const ProjectCard = ({ title, body, image, url }: IProjectCardProp) => {
  ...
  return (
    <div className="relative w-[300px] md:w-[400px] h-[200px] md:h-[250px] rounded-lg overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full px-3.5 py-2.5 flex flex-col justify-between text-white bg-black bg-opacity-30">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href={url}>
            <DivButton className="max-md:text-[13px] px-2.5 py-1">
              See more
            </DivButton>
          </Link>
        </div>
