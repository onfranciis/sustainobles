  ...
  return (
    <div className={poppins.className}>
      <div className="relative h-[376px] ">
        <div className="bg-[url('/landing-two.png')] bg-no-repeat bg-center bg-cover w-[calc(100%-200px)] absolute top-1/2 p-8 pr-[73px] pb-12 rounded-2xl left-0 right-0 ml-auto mr-auto">
      ...
      <div className="bg-white h-[376px]"></div>
    </div>
  );
};
