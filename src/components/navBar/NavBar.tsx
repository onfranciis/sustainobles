...
const NavBar = () => {
  ...
  return (
    <nav className="fixed z-50 top-0 flex items-center justify-between w-full px-[100px] -md:px-[30px] -sm:px-5 py-3 bg-primary max-w-[2000px] ">
      {isMenu && (
      ...
      <div className=" flex justify-center items-center -xl:flex-1 -xl:justify-end">
        <Link
          ...
          className="btn bg-secondary font-semibold"
          target="_blank"
        >
